...
class GuessingNumberGameTest(unittest.TestCase):
    ...
    def test_another_successful_first_attempt_when_number_generated_is_four(self):
        guess_number = GuessingNumberGame(4)

        first_attempt = guess_number.guess_number(4)
